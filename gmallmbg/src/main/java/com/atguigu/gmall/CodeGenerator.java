...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("F:\\idea2017_work\\gmall-parent\\gmallmbg"+"/src/main/java");
        gc.setAuthor("xcl");
        ...
        dsc.setUrl("jdbc:mysql://192.168.137.149:3307/gmall_"+ moduleName +"?useUnicode=true&useSSL=false&characterEncoding=utf8");
